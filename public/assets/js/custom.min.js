...
if(result==!0){jQuery("<span class='pq-thank-you-message pq-text-dark ms-3'>Thank You</span>").insertAfter('.pq-sidebars .pq-applyform .pq-button')}})});jQuery('#back-to-top').fadeOut();jQuery(window).on("scroll",function(){if(jQuery(this).scrollTop()>250){jQuery('#back-to-top').fadeIn(1400)}else{jQuery('#back-to-top').fadeOut(400)}});jQuery('#top').on('click',function(){jQuery('top').tooltip('hide');jQuery('body,html').animate({scrollTop:0},800);return!1});if($('#beer-slider').length>0){new BeerSlider(document.getElementById('slider'));$.fn.BeerSlider=function(options){options=options||{};return this.each(function(){new BeerSlider(this,options)})};$('.beer-slider').BeerSlider({start:50})}
...
jQuery('.timer').countTo();new WOW().init();$(document).ready(function(){$('.popup-youtube, .popup-vimeo, .popup-gmaps').magnificPopup({disableOn:700,type:'iframe',mainClass:'mfp-fade',removalDelay:160,preloader:!1,fixedContentPos:!1})})})(jQuery)